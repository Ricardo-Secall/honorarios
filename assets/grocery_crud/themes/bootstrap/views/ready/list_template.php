                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <div class="btn btn-sm btn-primary" href="<?php echo $add_url?>"><i class="fa fa-plus"></i> &nbsp; <?php echo $this->l('list_add'); ?> <?php echo $subject?></div>
                                </div>
                            <?php } ?>
                            <div class="floatR">
                                <?php if(!$unset_export) { ?>
                                    <div class="btn btn-sm btn-primary t5 gc-export" data-url="<?php echo $export_url; ?>">
                                ...
                                <?php } ?>
                                <?php if(!$unset_print) { ?>
                                    <div class="btn btn-sm btn-primary t5 gc-print" data-url="<?php echo $print_url; ?>">
                                ...
                                <a class="btn btn-sm btn-primary search-button t5">
