...
<script type='text/javascript'>
    ...
    <div class="Xcontainer gc-container container"><!-- Ricardo-->
 		...
 		<div class="row">
        	<div class="table-section">
                ...
                <div class="table-container">
                    <?php //print_r($this->avante);die();?>
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                         <?php $display=""; if($this->avante["show_operation_bar2"]==false){ 
                        ...
                        <div class="header-tools" <?php echo $display ?>>
                            ...
                            <div class="floatR">
                                ...
                                <?php } ?>
                                <?php if(!$unset_print) { ?>
                                    <div class="btn btn-md btn-link t5 gc-print" data-url="<?php echo $print_url; ?>">
        			    ...
        			    <table class="table table-responsive grocery-crud-table table-hover">
        					<thead>
        						...
        						<tr>
                                 ...
                                 <!-- Avanteartificion para habilitar refresh del grid
                                    en js solo hacdr  $('.gc-refresh').trigger('click');
                                  -->
                                <a style="display:none" href="javascript:void(0);" class="btn btn-default gc-refresh">
                                                <i class="fa fa-refresh"></i>
                                </a>
                                <!-- Avante para mostrar la linea de opciones -->
                                <?php if($this->avante["show_operation_bar"]==true){ // Ricardo ?>

        						<tr class="filter-row gc-search-row">
                                    <!-- Ricardo: encabezados search-->
                                    <?php foreach($columns as $column){?>
                                        <td>
                                    ...
                                    <?php }?>
                                    <!-- Ricardo: encabezados search FIN-->
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li>
                                                            <a href="javascript:void(0)" class="clear-filtering">
                                                                <i class="fa fa-eraser"></i> Listado Original
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
