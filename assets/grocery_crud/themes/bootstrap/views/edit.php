...
<div class="crud-form" data-unique-hash="<?php echo $unique_hash; ?>">
    <div class="Xcontainer gc-container"><!-- Ricardo-->
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-container table-container">
                        <?php echo form_open( $update_url, 'method="post" id="crudForm"  enctype="multipart/form-data" class="form-horizontal"'); ?>
                            <!-- Ricardo: Alert Message-->
                            <div class="form-group col-sm-12 ">
                                <div id='report-error' class='report-div error alert-danger ' style="display:none"></div>
                                <div id='report-success' class='alert alert-success fade in' style="display:none"></div>
                            </div>
