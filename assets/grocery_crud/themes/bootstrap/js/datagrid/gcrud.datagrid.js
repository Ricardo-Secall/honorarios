...
(function ($) {
    ...
    Datagrid.prototype.checkCachedData = function () {
        ...
        if (typeof cachedDatra.search_text === "string") {
            ...
            $('#cole-search').val(cachedDatra.search_text); // ricardo
            this.gcrud_container.find('.search-button > input.search-input').val("");/* Ricardo funciones lo de view o edit Para que Colesearch */
            $('.search-button').removeClass('search-button-big');
            $('#cole-search').focus();
            return true;
        }

        if(cachedDatra.search_text){ // Ricardo , para evitar Error 
    ...
    Datagrid.prototype.listenerSearchInput = function () {
        ...
        /* Ricardo */
      /*  $("#cole-search").change(function(){
            datagrid_object.SearchAndOrderingTrigger();
           
        });*/

        /* Para */
        $('#cole-search').on('keyup change', function (event) {
...
//alert("a");
    ...
    Datagrid.prototype.listenerSearchButton = function () {
        ...
        $('.search-button').click(function (event) {
            ...
            //Ricardo search_button.removeClass('btn-primary').addClass('btn-default');
        ...
        $('.search-button>input.search-input').blur(function () {
            ...
            if ($(this).val() === '' && search_button.hasClass('search-button-big')) {
                ...
                //Ricardo search_button.removeClass('btn-default').addClass('btn-primary');
            }
        });
